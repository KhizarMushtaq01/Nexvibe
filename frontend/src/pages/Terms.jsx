        ...
        <div className="bg-[var(--bg-secondary)] rounded-3xl border border-[var(--border)] p-6 sm:p-10">
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="bg-yellow-50 dark:bg-yellow-950/30 border border-yellow-200 dark:border-yellow-800 rounded-2xl p-4 mt-4">
                <p className="text-sm text-yellow-800 dark:text-yellow-200">
                  ⚠️ You are responsible for ensuring you have all necessary rights to any content you post. Do not post content that infringes on others' rights.
                </p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="mt-3 p-4 bg-[var(--bg-primary)] rounded-xl border border-[var(--border)]">
                <p className="text-sm">📧 Email: legal@nexvibe.com</p>
                <p className="text-sm mt-2">📍 Address: 123 Social Street, Digital City, DC 12345</p>
              </div>
            </section>
